...
public class Messages {
	...
	public static final String LOGINERROR = "login_error";//148
	public static final String BRANDCANTREPEAT = "brand_cant_repeat";//148
	public static final String EXPECTEDDATENOTBEFOREMAINTENANCEDATE = "expected_date_not_before_maintenance_date";//150
	public static final String RETURNDATENOTBEFOREMAINTENANCEDATE  = "return_date_not_before_maintenance_date";//151
	public static final String FORMATERROR = "format_error";
	public static final String FOREIGNKEYERROR = "This id cannot be deleted because it is related to another table.";
	public static final String CREDITCARDLIMIT= "credit_card_limit";
	public static final String ADDITIONALCANNOTREPEAT = "additional_can_not_repeat";
	public static final String RENTALINVOICEEXIST = "rentals_invoice_exist";
	public static final String INVOICEDATECANNOTBEFORERENTDATE ="invoice_date_can_not_before_return_date";
	public static final String CARISDELIVERED = "car_is_delivered";
	public static final String RETURNDATECANNOTBEFORERENTDATE = "return_date_can_not_before_rent_date";
	public static final String RETURNKMCANNOTLESSSTARTKM = "return_km_can_not_less_start_km";
